...
router = APIRouter(prefix="/api/v1/veo-3", tags=["Veo 3"])
...
async def create_veo3_video(
    ...
    """
    logger.info("=" * 80)
    logger.info("VEO 3 REQUEST RECEIVED")
    ...
    new_job = GenerationJob(
        job_id=job_id,
        model_type=VideoModel.VEO_3.value,
    ...
    # background_tasks.add_task(process_veo3, job_id, db)
