...
router = APIRouter(prefix="/api/v1/kling", tags=["Kling"])
...
async def create_kling_video(
    ...
    """
    logger.info("=" * 80)
    logger.info("KLING REQUEST RECEIVED")
    ...
    new_job = GenerationJob(
        job_id=job_id,
        model_type=VideoModel.KLING.value,
    ...
    # background_tasks.add_task(process_kling, job_id, db)
